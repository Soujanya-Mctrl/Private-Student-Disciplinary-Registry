...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      addDisciplinaryAction: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`addDisciplinaryAction: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const studentId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('addDisciplinaryAction',
                                     'argument 1 (as invoked from Typescript)',
                                     'disciplinary.compact line 13 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(studentId_0) === 'bigint' && studentId_0 >= 0 && studentId_0 <= __compactRuntime.MAX_FIELD)) {
      ...
      verifyRecord: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyRecord',
                                     'argument 1 (as invoked from Typescript)',
                                     'disciplinary.compact line 21 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(studentId_0) === 'bigint' && studentId_0 >= 0 && studentId_0 <= __compactRuntime.MAX_FIELD)) {
  ...
  _addDisciplinaryAction_0(context, partialProofData, studentId_0) {
    ...
    if (current_0 < 1000n) {
      const tmp_0 = ((t1) => {
                      if (t1 > 18446744073709551615n) {
                        throw new __compactRuntime.CompactError('disciplinary.compact line 17 char 42: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                      }
                      return t1;
                    })(current_0 + 1n);
      __compactRuntime.queryLedgerState(context,
